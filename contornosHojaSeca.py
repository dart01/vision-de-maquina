...
img = cv2.imread('C:/Users/gdavi/OneDrive/Documentos/Vision/Imagenes/hoja.jpg')
img_original = img.copy()
img_byn = cv2.cvtColor(img, cv2.COLOR_BGR2GRAY)

def mostrar_imagen_binarizada(umbral):
    global img_umbral
    _, img_umbral = cv2.threshold(img_byn, umbral, 255, cv2.THRESH_BINARY_INV) #Se escoge el tipo de filtro Tresh binary al ser la hoja más oscura que el fondo
